...

  {
    ...
    if (generateContainer) {
      addComponents(
        [
          {
            '.container, .container-fluid, sm\:container, md\:container, lg\:container, xl\:container': {
          ...
          ...screenKeys.filter(item => {
            return item !== 'xs' && item !== 'sm' && item !== 'md';
          }).map((name) => {
            return ({
              [`@screen ${name}`]: {
                '.lg\:container': {
          ...
          ...screenKeys.filter(item => {
            return item !== 'xs' && item !== 'sm' && item !== 'md' && item !== 'lg';
          }).map((name) => {
            return ({
              [`@screen ${name}`]: {
                '.xl\:container': {
